...
@Component({
  selector: 'app-lashcourses',
  templateUrl: './lashcourses.component.html',
  styleUrls: ['./lashcourses.component.css']
})
export class LashcoursesComponent implements OnInit {productList: any = [];
