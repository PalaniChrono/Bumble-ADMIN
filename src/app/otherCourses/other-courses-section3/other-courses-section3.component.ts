...
@Component({
  selector: 'app-other-courses-section3',
  templateUrl: './other-courses-section3.component.html',
  styleUrls: ['./other-courses-section3.component.css']
})
export class OtherCoursesSection3Component implements OnInit {
  ...
  updateSecTwo() {
    ...
    this.apiCall("update", "updateOtherCourseSectionThree", value);
  }
  updateSecthree() {
    const value = {
