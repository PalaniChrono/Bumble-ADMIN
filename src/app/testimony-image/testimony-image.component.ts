...
@Component({
  selector: 'app-testimony-image',
  templateUrl: './testimony-image.component.html',
  styleUrls: ['./testimony-image.component.css']
})
export class TestimonyImageComponent implements OnInit {
    ...
    imageUpdateCategory(imageFile) {
        ...
        this.apiService.postData(formData, 'imageUpdateTestimony').subscribe(data => {
        if (data.error === false) {
