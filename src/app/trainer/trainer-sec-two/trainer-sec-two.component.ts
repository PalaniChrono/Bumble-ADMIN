...
// @Component({
//   selector: 'app-trainer-sec-two',
//   templateUrl: './trainer-sec-two.component.html',
//   styleUrls: ['./trainer-sec-two.component.css']
// })
// export class TrainerSecTwoComponent implements OnInit {
...
export class TrainerSecTwoComponent implements OnInit {productList: any = [];
  loading = false;
  loadingBtn = false;
  showPopup = false;
  stockBox = false;
