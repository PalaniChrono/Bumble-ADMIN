...
@Component({
  selector: 'app-lash-talk-sec-two',
  templateUrl: './lash-talk-sec-two.component.html',
  styleUrls: ['./lash-talk-sec-two.component.css']
})
export class LashtalkSecTwoComponent implements OnInit {productList: any = [];
