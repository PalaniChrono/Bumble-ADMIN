...
// @Component({
//   selector: 'app-lash-talk-sec-three',
//   templateUrl: './lash-talk-sec-three.component.html',
//   styleUrls: ['./lash-talk-sec-three.component.css']
// })
// export class LashTalkSecThreeComponent implements OnInit {
...
export class LashtalkSecThreeComponent implements OnInit {productList: any = [];
