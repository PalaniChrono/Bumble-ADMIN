...
@Component({
  selector: 'app-homesection4',
  templateUrl: './homesection4.component.html',
  styleUrls: ['./homesection4.component.css']
})
export class Homesection4Component implements OnInit {
  ...
  gethomecontent(){
    ...
    this.apiService.getData('getHomeContent').subscribe((data) => {
       ...
       this.card3_img = value[0].home_card3_img;
       this.card3_iconimg  = value[0].home_card_3_iconImg;
  this.home_card3_heading = value[0].home_card3_heading;
  this.home_card_3_textcontent = value[0].home_card3_textcontent    ;
  this.loading = false;
...
updateHomeCard3() {
  const value = {
  home_card3_heading :  this.home_card3_heading ,
   home_card3_textcontent  :  this.home_card_3_textcontent,

  }
  if(this.home_card_3_textcontent.length>340){
    this.openPopup();
  }
  else{
    this.apiCall("update", "updateHomeCard3", value);
