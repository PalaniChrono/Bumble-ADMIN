...
@Component({
  selector: 'app-readmore1',
  templateUrl: './readmore1.component.html',
  styleUrls: ['./readmore1.component.css']
})
export class Readmore1Component implements OnInit {
  ...
  getcousesContent() {
    ...
    this.apiService.getData("getCourseSection").subscribe(
      (data) => {
        ...
        this.courOneSummary = value[0].MoreOne_SecOne;
        this.courOneHead1 = value[0].MoreOne_SecTwo_TxtOne;
        this.firstsec = value[0].MoreOne_SecTwo_ColOne;
        this.secondsec = value[0].MoreOne_SecTwo_ColTwo;
        this.thirdsec = value[0].MoreOne_SecTwo_ColThree;
        this.foursec = value[0].MoreOne_SecThree_Txt;
        this.certificateimg = value[0].MoreOne_SecThree_Img;
